...
control "SV-218030" do
  ...
  desc "default", "Permissions on audit binaries and configuration files that are too
...
deviations from this baseline should be investigated."
  desc "check", "The following command will list which audit files on the system have permissions different from what is expected by the RPM database: 
