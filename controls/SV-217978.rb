...
control "SV-217978" do
  ...
  desc "default", "Auditing file deletions will create an audit trail for files that are
...
conceal their presence."
  desc "check", "To determine if the system is configured to audit user deletions of files and programs, run the following command:
