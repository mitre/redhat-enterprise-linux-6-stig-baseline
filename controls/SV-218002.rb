...
control "SV-218002" do
  ...
  desc "default", "The warning message reinforces policy awareness during the logon
...
that does not provide easy attribution."
  desc "check", "To determine how the SSH daemon's \"Banner\" option is set, run the following command: 
