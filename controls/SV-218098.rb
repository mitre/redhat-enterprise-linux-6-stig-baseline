...
control "SV-218098" do
  ...
  desc "default", "Permissions on system binaries and configuration files that are too
...
deviations from this baseline should be investigated."
  desc "check", "The following command will list which files and directories on the system have permissions different from what is expected by the RPM database: 
