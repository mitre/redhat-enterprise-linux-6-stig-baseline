...
control "SV-218047" do
  ...
  desc "default", "Passwords with excessive repeating characters may be more vulnerable
...
If \"maxrepeat\" is not found, is set to zero, or is set to a value greater than \"3\", this is a finding."
  desc "fix", "The pam_cracklib module's \"maxrepeat\" parameter controls requirements for consecutive repeating characters. When set to a positive number, it will reject passwords which contain more than that number of consecutive characters.
